...
class ErcfCutterServo:
    def __init__(self, config):
        ...
        gcode.register_mux_command('ERCF_SET_CUTTER_SERVO', 'SERVO', servo_name, self.cmd_SET_CUTTER_SERVO, desc=self.cmd_SET_CUTTER_SERVO_help)
    ...
    cmd_SET_CUTTER_SERVO_help = 'Set servo angle'
    def cmd_SET_CUTTER_SERVO(self, gcmd):
